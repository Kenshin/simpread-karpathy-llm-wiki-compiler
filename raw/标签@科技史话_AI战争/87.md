# Claude 通过率不到 4％，SaaS-Bench 撕碎了 Computer-Use 的「全自动办公」幻想 - 36 氪

[原文地址](https://36kr.com/p/3824057526259840)

[本地快照](http://localhost:7026/reading/5286)
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687444/simpread/3803e97b52ca84ca7d8484aefdce1c32df270151.jpg)
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687445/simpread/9c448c93a61303f6842111c821107107aae95076.jpg)
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687447/simpread/87ec88366fca6de2dc3fe540f698f7a008e544ae.jpg)
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687448/simpread/5ba4c9bec1e8c53270d046deac932f7f52017afa.jpg)
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687449/simpread/e8857c2bb9feeca03f7351aa7fa90f1134649c84.jpg)
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687451/simpread/d76badd822953aaafd4a29d212875ef66311f19a.jpg)
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687452/simpread/87ee7a7bde5a4671e2656390004a6b2bdb2129aa.jpg)
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687454/simpread/fcabb0e0be14db4cc4f7bccfe760a8403041239f.jpg)
...
这组数字的含义极其残酷：Agent 可以推进工作的部分中间环节，但**几乎没有能力将一个完整的长程工作流走完。**

## **多跑几次能救吗？**

![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687456/simpread/06dd221fe428ed754b95f11f06d2f57292ab72b7.jpg)

四个模型的 Pass@k 结果

把每个模型在同一任务上独立跑 3 次，对一次就算通过。pass@3 相比 pass@1 整体提升约 8 个百分点。

Sonnet 4.6 在多模态任务上从 33.9% 跳到 52.1%（+18.2pp）—— 它并非完全不行，而是**执行极不稳定**。
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687457/simpread/14659370143db6188cc3201a62d9b53cd645956b.jpg)
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687458/simpread/34b549060fc6569d9e97f2ad8d9f80bfd66a0978.jpg)
...
一个典型案例：任务要求创建一个**公司**客户「Arcturus Digital」。Agent 同时填了联系人姓名和公司名，触发了**个人**客户逻辑，实际创建的是个人客户 Elena Vasquez。

此后的 10 张发票、付款记录、账户对账，**全部挂在错误实体下**。核心检查点权重仅 3%，但导致了下游 30% 的权重损失。

![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687459/simpread/591f4f5273442922f355f11b6de7afd6f89ec225.jpg)
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687460/simpread/781348c0a4914c52a6a503df3e2616d537816fd8.jpg)
...
![](https://res.cloudinary.com/dvyu4sgrr/image/upload/v1779687462/simpread/4533ad271a2c24166d433d8cfa5c8779bbaaecf6.jpg)
...
本文来自微信公众号 [“机器之心”](https://mp.weixin.qq.com/s/DZIzuzR7W0jZH0QFoBKQAA)，36 氪经授权发布。